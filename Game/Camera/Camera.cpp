...
Camera::Camera() {
	worldPos = { static_cast<float>(640) / 2.0f, static_cast<float>(480) / 2.0f };
	screenPos = { 0.0f,0.0f };

	drawLeftTop = { static_cast<float>(640) / -2.0f, static_cast<float>(480) / 2.0f };
	drawRightBottom = { static_cast<float>(640) / 2.0f, static_cast<float>(480) / -2.0f };

	size = { static_cast<float>(640), static_cast<float>(480) };
	scale = 1.0f;
